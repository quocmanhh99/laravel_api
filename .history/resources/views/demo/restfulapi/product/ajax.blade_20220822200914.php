...
<table class="table table-bordered border-primary">
    <thead>
        <tr>
            ...
            <th scope="col"><a href="javascript:void(0)" class="link" id='btn_Luu'>Name</a></th>
...
<script>
    $(document).ready(function(){
        $("#btn_Luu").click( function(){
            var diachi = "https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=desc";
            $.ajax({
                url: diachi,
                data: $("#frm1").serialize(),
                dataType:'json',
