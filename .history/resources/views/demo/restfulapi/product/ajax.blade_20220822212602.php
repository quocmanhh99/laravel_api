...
<table class="table table-bordered border-primary">
    <thead>
        <tr>
            ...
            <th scope="col">Name
                <a href="?sort=product_name&by=desc" class="link" id=''><i class="fa-solid fa-arrow-down"></i></a>
                <a href="?sort=product_name&by=asc" class="link" id=''><i class="fa-solid fa-arrow-up"></i></a>
            </th>
...
url = `https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=`;
    ...
    const linkAsc = document.querySelector(".linkDesc");
