...
<table class="table table-bordered border-primary">
    <thead>
        <tr>
            ...
            <th scope="col"><a href="?sort=product_name&by={{ $by }}" class="link" id=''>Name</a></th>
...
url = `https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=`;
    ...
    // let url;
    // if(by == 'desc'){
    //     url = `https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=asc`;
    // }else{
    //     url = `https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=desc`;
    // }
    ...
    link.addEventListener("click", function(event) {
        ...
        let by = getParameterByName('by', url)
