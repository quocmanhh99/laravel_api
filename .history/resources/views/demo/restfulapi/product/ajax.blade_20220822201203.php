...
<table class="table table-bordered border-primary">
    <thead>
        <tr>
            <form id="frm1" method="get" class="row" enctype='multipart/form-data' >
            <th scope="col"><a href=""></a> </b></th>
            <th scope="col">ID <i class="fa-solid fa-arrow-down-arrow-up"></i></th>
            <th scope="col"><a href="javascript:void(0)" class="link" id='btnSave'>Name</a></th>
...
<script>
    $(document).ready(function(){
        $("#btnSave").click( function(){
            var address = "https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=desc";
