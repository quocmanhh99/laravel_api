...
url = `https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=`;
    ...
    const linkPriceDesc = document.querySelector(".linkDesc");
    const linkPriceAsc = document.querySelector(".linkAsc");
