...
<table class="table table-bordered border-primary">
    <thead>
        <tr>
            ...
            <th scope="col"><a href="?sort=product_name&by=desc" class="link" id=''>Name</a></th>
...
<script>
    let url = `https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=desc`;
    ...
    link.addEventListener("click", function(event) {
        ...
        fetch('https://quocmanh.com/Laravel-8/api/demo/restfulapi/product/show?sort=product_name&by=desc', {
                method: 'POST',
                headers: {
