...
<table class="table table-bordered border-primary">
    <thead>
        <tr>
            ...
            <th scope="col"><a href="?sort=product_name&by=desc" class="linkProduct">Name</a></th>
...
<script>
    const link = document.querySelector("a.linkProduct");
    console.log(link)
    $(document).ready(function(){
        $('body').on('click', 'a.linkProduct', function(e) {
            e.preventdefault();
