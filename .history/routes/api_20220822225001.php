...
Route::prefix('demo/restfulapi/')->group(function () {
    ...
    Route::get('searchProduct', [RestFulApiController::class, 'searchProduct'])->name('demo.restfulapi.sortProduct');
    Route::get('searchProduct', [RestFulApiController::class, 'searchProduct'])->name('demo.restfulapi.Product');
