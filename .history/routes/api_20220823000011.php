...
Route::prefix('demo/restfulapi/')->group(function () {
    ...
    Route::post('product', [RestFulApiController::class, 'show'])->name('demo.restfulapi.product');
    ...
    Route::get('searchProduct', [RestFulApiController::class, 'searchProduct'])->name('demo.restfulapi.searchProduct');
    Route::post('searchProduct', [RestFulApiController::class, 'searchProduct'])->name('demo.restfulapi.searchProduct');
