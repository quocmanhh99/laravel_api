...
class RestFulApiController extends Controller
{
    ...
    {
        $data = DemoProduct::orderBy('product_name', 'desc')->paginate(5);
    ...
    {
        $by = 'asc';
        $products = DemoProduct::orderBy('product_name', 'desc'>->paginate(15);
        return view('demo.restfulapi.product.ajax', compact('products','by'))->render();
