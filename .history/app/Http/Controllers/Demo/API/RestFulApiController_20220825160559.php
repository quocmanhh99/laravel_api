...
class RestFulApiController extends Controller
{
    ...
    {
        $data = DemoProduct::orderBy('product_name', 'desc')->paginate(4);
    ...
    public function searchProduct(Request $request){
        ...
        return $products = DemoProduct::where('product_name', 'like', "%{$search}%")->get();
        return response()->json([
            'data' => $products,
            'status_code' => 200,
            'message' => 'Hiển thị dữ liệu thành công',
    ...
    {
        $by = 'asc';
        $products = DemoProduct::orderBy('product_name', 'desc')->paginate(4);
