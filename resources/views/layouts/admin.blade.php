            ...
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active == 'user' ? 'active' : '' }}">
                        <a href="{{ route('projectv1.user.list') }}">
                            <div class="nav-link-icon d-inline-flex">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ route('projectv1.user.add') }}">Thêm mới</a></li>
                            <li><a href="{{ route('projectv1.user.list') }}">Danh sách</a></li>
                        </ul>
                    </li>
                    <li class="nav-link {{ $module_active == 'Courses' ? 'active' : '' }}">
                        <a href="{{ route('demo.courses.index') }}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-user"></i>
                            </div>
                            Khóa học
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ route('demo.courses.add') }}">Thêm mới</a></li>
                            <li><a href="{{ route('demo.courses.list') }}">Danh sách</a></li>
                        </ul>
                    </li>
