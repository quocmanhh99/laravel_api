        ...
        <div class="media-body">
            ...
            <form action="" method="post" style="display: none" class="formReply form-reply-{{ $comm->id }}">
                <div class="form-group">
                    ...
                    <hr>
                    <button type="submit" class="btn btn-secondary btn-send-comment-reply"
                        data-id="{{ $comm->id }}">
            ...
            @foreach ($comm->replies as $child)
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>{{ $child->content }}</p>
                        <a href="" class="btn btn-success btn-show-reply-form" data-id="{{ $child->id }}">Trả
                            lời</a>
                        </p>
                        <form action="" method="post" style="display: none"
                            ...
                            <div class="form-group">
                                <label for="">Nội dung bình luận</label>
                                <input type="hidden" value="" name='blog_id'>
                                <textarea id="content-reply-{{ $child->id }}" cols="10" rows="5" name="content-reply"
                                    class="form-control" placeholder="Nhập nội dung(*)"></textarea> <br>
                                <hr>
                                <button type="submit" class="btn btn-secondary btn-send-comment-reply"
                                    data-id="{{ $child->id }}">
                                    Gửi nội dung trả lời
                        ...
                        @foreach ($child->replies as $child1)
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>{{ $child1->content }}</p>
                                    <a href="" class="btn btn-success btn-show-reply-form"
                                        data-id="{{ $child1->id }}">Trả lời</a>
                                    </p>
                                    <form action="" method="post" style="display: none"
                                        class="formReply form-reply-{{ $child1->id }}">
                                        <div class="form-group">
                                            <label for="">Nội dung bình luận</label>
                                            <input type="hidden" value="" name='blog_id'>
                                            <textarea id="content-reply-{{ $child1->id }}" cols="10" rows="5" name="content-reply"
                                                class="form-control" placeholder="Nhập nội dung(*)"></textarea> <br>
                                            <hr>
                                            <button type="submit" class="btn btn-secondary btn-send-comment-reply"
                                                data-id="{{ $child1->id }}">
                                    ...
                                    @foreach ($child1->replies as $child2)
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>{{ $child2->content }}</p>
                                                <a href="" class="btn btn-success btn-show-reply-form"
                                                    data-id="{{ $child2->id }}">Trả lời</a>
                                                </p>
                                                <form action="" method="post" style="display: none"
                                                    class="formReply form-reply-{{ $child2->id }}">
                                                    <div class="form-group">
                                                        <label for="">Nội dung bình luận</label>
                                                        <input type="hidden" value="" name='blog_id'>
                                                        <textarea id="content-reply-{{ $child2->id }}" cols="10" rows="5" name="content-reply"
                                                            class="form-control" placeholder="Nhập nội dung(*)"></textarea> <br>
                                                        <hr>
                                                        <button type="submit"
                                                            class="btn btn-secondary btn-send-comment-reply"
                                                            data-id="{{ $child2->id }}">
                                                            Gửi nội dung trả lời
                                                        </button>
                                                    </div>
                                                ...
                                                @foreach ($child2->replies as $child3)
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p>{{ $child3->content }}</p>
                                                            <a href=""
                                                                class="btn btn-success btn-show-reply-form"
                                                                data-id="{{ $child3->id }}">Trả lời</a>
                                                            </p>
                                                            <form action="" method="post" style="display: none"
                                                                class="formReply form-reply-{{ $child3->id }}">
                                                                <div class="form-group">
                                                                    <label for="">Nội dung bình luận</label>
                                                                    <input type="hidden" value=""
                                                                        name='blog_id'>
                                                                    <textarea id="content-reply-{{ $child3->id }}" cols="10" rows="5" name="content-reply"
                                                                        class="form-control" placeholder="Nhập nội dung(*)"></textarea> <br>
                                                                    <hr>
                                                                    <button type="submit"
                                                                        class="btn btn-secondary btn-send-comment-reply"
                                                            ...
                                                            @foreach ($child3->replies as $child4)
                                                                <div class="media">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <a href=""
                                                                            class="btn btn-success btn-show-reply-form"
                                                                            data-id="{{ $child4->id }}">Trả lời</a>
                                                                        </p>
                                                                        <form action="" method="post"
                                                                            style="display: none"
                                                                            class="formReply form-reply-{{ $child4->id }}">
                                                                            <div class="form-group">
                                                                                <label for="">Nội dung bình
                                                                                    luận</label>
                                                                                <input type="hidden" value=""
                                                                                    name='blog_id'>
                                                                                <textarea id="content-reply-{{ $child4->id }}" cols="10" rows="5" name="content-reply"
                                                                                    class="form-control" placeholder="Nhập nội dung(*)"></textarea> <br>
                                                                                <hr>
                                                                                <button type="submit"
                                                                                    class="btn btn-secondary btn-send-comment-reply"
                                                                        ...
                                                                        @foreach ($child4->replies as $child5)
                                                                            <div class="media">
                                                                                ...
                                                                                <div class="media-body">
                                                                                    ...
                                                                                    <a href=""
                                                                                        class="btn btn-success btn-show-reply-form"
                                                                                        data-id="{{ $child5->id }}">Trả
                                                                                        lời</a>
                                                                                    </p>
                                                                                    <form action=""
                                                                                        method="post"
                                                                                        style="display: none"
                                                                                        class="formReply form-reply-{{ $child5->id }}">
                                                                                        <div class="form-group">
                                                                                            <label for="">Nội
                                                                                            ...
                                                                                            <input type="hidden"
                                                                                                value=""
                                                                                                name='blog_id'>
                                                                                            <textarea id="content-reply-{{ $child5->id }}" cols="10" rows="5" name="content-reply"
